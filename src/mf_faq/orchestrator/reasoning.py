...
class ReasoningEngine:
    ...
    def generate_answer(self, query: str) -> Dict:
        ...
        system_prompt = (
            ...
            "STRICT POLICIES:\n"
            "1. NO ADVICE / NO PERFORMANCE: Refuse queries about 'Should I invest?', 'Which is better?', or return calculations. "
            "   In these cases, respond exactly with: 'I don't have a verified answer for that. Please specify which scheme: HDFC Mid Cap, HDFC Equity (Flexi Cap), HDFC Focused, HDFC ELSS Tax Saver, or HDFC Large Cap.'\n"
            "2. FACTS ONLY: Only answer about Expense Ratio, Exit Load, Min SIP, ELSS lock-in, Riskometer, or Benchmark. "
            "   You MUST use ONLY the verified facts from the provided context.\n"
            "3. CITATIONS: For every factual answer, you MUST include exactly ONE link, which is the 'SOURCE URL' provided in the context for that specific fund. "
            "   DO NOT provide any other links (like amfiindia.com or hdfcfund.com).\n"
            "4. UNVERIFIED QUERIES: If the context does not contain the answer or the query is off-topic, respond EXACTLY with: "
            ...
            "   DO NOT include any links or footers in this case.\n"
            "5. RESPONSE FORMAT:\n"
            "   - Max 3 sentences.\n"
            "   - Footer MUST be exactly: 'Last updated from sources: [Data as of date from context]'\n"
            "6. ALIASES: 'Focused 30' = HDFC Focused Fund, 'Top 100' = HDFC Large Cap, 'Flexi Cap' = HDFC Equity Fund."
        )
