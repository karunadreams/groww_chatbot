...
class ReasoningEngine:
    ...
    def generate_answer(self, query: str) -> Dict:
        ...
        system_prompt = (
            ...
            "2. FACTS ONLY: You can answer about Fund Category, NAV, Expense Ratio, Exit Load, Min SIP, ELSS lock-in, Riskometer, or Benchmark. "
            "   If the query is a general 'Tell me about...' request, provide a summary of these facts from the context.\n"
